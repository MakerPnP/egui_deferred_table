            ...
            egui::ScrollArea::both()
                .show(ui, |ui| {
                    ...
                    let (_response, actions) = DeferredTable::new(ui.make_persistent_id("table_1"))
                        .show(ui, &mut *data_source, |builder: &mut DeferredTableBuilder<MySource, CellValue>| {
...
impl DeferredTableDataSource<CellValue> for MySource {
    ...
    fn render_cell(&self, ui: &mut Ui, row: usize, col: usize) {
        // TODO remove get_cell_value from the trait
